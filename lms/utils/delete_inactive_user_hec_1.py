...
email_notification_gap = 5
email_notification_gap_2 = 10
email_notification_gap_3 = 33
email_notification_gap_4 = 37
...
# koa-qualif
# course_ids = [
#     "course-v1:hec-pole-emploi+01+2024"
# ]
...
for course_id in course_ids:
    ...
    for i in range(len(course_enrollments)):
        ...
        # RAJOUTER UNE condition POUR SUPPRIMER LES PERSONNES QUI ONT TERMINÉES LE COURS ? 
        ...
        # si le cours n'est pas terminé à 100% aprés 35 jours
        # EST CE QUE gradesTest EST EN POURCENTAGE ?
        elif (user.date_joined == now - timedelta(days=(limited_period_access - email_notification_gap)) and gradesTest <= 0.7) :
        ...
        elif (user.date_joined == now - timedelta(days=(limited_period_access - email_notification_gap_2)) and gradesTest <= 0.7) :
        ...
        # si le cours n'est pas Commencé aprés 7 jours
        elif (user.date_joined == now - timedelta(days=(limited_period_access - email_notification_gap_3)) and len(detailed_time_tracking) == 0 ) :
            ...
            try:
                ...
                all_treated_users.append('******* DEFAULT EMAIL 3 ******  '+user.email)


        # si le cours n'est pas Commencé aprés 3 jours
        elif (user.date_joined == now - timedelta(days=(limited_period_access - email_notification_gap_4)) and len(detailed_time_tracking) == 0 )  :
            ...
            try:
                ...
                all_treated_users.append('******* DEFAULT EMAIL 4 ******  '+user.email)
...
# /edx/app/edxapp/venvs/edxapp/bin/python /edx/app/edxapp/edx-themes/hec-pole-emploi/lms/utils/delete_inactive_user_hec_1.py 'cyril.adolf@weuplearning.com'
