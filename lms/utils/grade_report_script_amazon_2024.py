...
html = "<html><head></head><body><p>Salve,<br/><br/>In allegato troverete il report dei dati di Amazon<br/><br/>Buona accoglienza<br />Il Weup Learning squadra</html>"
