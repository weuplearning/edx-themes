...
for email in emails:
  ...
  msg['From'] = fromaddr
  msg['To'] = email
  msg['Subject'] = "umn - rapports de notes référent"
...
# /edx/app/edxapp/venvs/edxapp/bin/python /edx/app/edxapp/edx-themes/umn/lms/utils/grade_reports_referents/script.py 'theo.gicquel@weuplearning.com' 'course-v1:umn+pi+01'