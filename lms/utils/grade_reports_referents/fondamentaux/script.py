...
for ref in referents_list:
  ...
  for target_ref in split_ref:
    ...
    msg['Subject'] = "Suivi du e-learning Passeport Nucléaire parcours Fondamentaux"
...
# /edx/app/edxapp/venvs/edxapp/bin/python /edx/app/edxapp/edx-themes/umn/lms/utils/grade_reports_referents/fondamentaux/script.py 'theo.gicquel@weuplearning.com' 'course-v1:umn+test+test;course-v1:umn+pn+02'